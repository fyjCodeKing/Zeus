package com.filepassapp.chenze.filepass.WifiHostTool;
...
/**
 * Created by chenze on 2017/2/26.
 */
public class WifiHostBiz {

    private final String TAG = "WifiHostBiz";
    private WifiManager wifiManager;
    private String WIFI_HOST_SSID = "雪媳";
    private String WIFI_HOST_PRESHARED_KEY = "cz123456";// 密码必须大于8位数
